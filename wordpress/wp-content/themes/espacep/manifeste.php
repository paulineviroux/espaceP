...
<body>
    ...
    <section class="main-manifeste">
                    ...
                    <h2 role="heading" aria-level="2" class="manifeste-point__title"><?php the_sub_field( 'manifeste-point-title' ) ;?></h2>
                        <?php if( have_rows( 'container-text-point' ) ): ?>
                            <?php while ( have_rows( 'container-text-point' ) ) : the_row(); ?>
                                <h3 role="heading" aria-level="3" class="manifeste-point__subtitle" id="<?php the_sub_field( 'manifeste-point-subtitle' ) ;?>"><?php the_sub_field( 'manifeste-point-subtitle' ) ;?></h3>
        ...
        <div class="manifeste-point" id="<?php the_title(); ?>">
            ...
            <p class="manifeste-point__p">En adhérant à notre manifeste, vous participez au respect et à la sécurité des droits des travailleurs du sexe et vous permettez que progressivement les regards se modifient positivement.</p>
            <!-- <p >Si vous désirez adhérer à celui-ci, merci de remplir ce formulaire.</p> -->
