...
<body>
    <header class="headerProfil">
        <h1 class="headerProfil__title">Clients</h1>
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/profil3.jpg" alt="" class="headerProfil__profil">
    ...
    <section class="main-tds">
        ...
        <?php $posts = new WP_Query( ['category_name' => 'profilclient'] );
